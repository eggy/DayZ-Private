...
if ($args{'help'}) {
	...
	print "     This script downloads updated BE filters from the community list and then modifies them to make them compatible with ECPrivate optional features.\n";
